...
class wuestite_ss(burnman.SolidSolution):
    def __init__(self):
        ...
        endmembers = [[wustite(), '[Fe]O'],[defect_wustite(), '[Fef2/3Vc1/3]O']]
...
def fit_params(mineral):
    def fit(data, H0_FeO, H0_defect_wustite, S0_FeO, S0_defect_wustite, alpha_defect_wustite, interaction):
        # Endmember tweaking
        mineral.endmembers[0][0].params['H_0'] = H0_FeO
        mineral.endmembers[1][0].params['H_0'] = H0_defect_wustite

        mineral.endmembers[0][0].params['S_0'] = S0_FeO
        mineral.endmembers[1][0].params['S_0'] = S0_defect_wustite
