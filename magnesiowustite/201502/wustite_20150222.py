...
def fit_params(mineral):
    def fit(data, H0_FeO, H0_defect_wustite, S0_FeO, S0_defect_wustite):
        # Endmember tweaking
...
guesses=[wus.endmembers[0][0].params['H_0'], wus.endmembers[1][0].params['H_0'], wus.endmembers[0][0].params['S_0'], wus.endmembers[1][0].params['S_0']]
