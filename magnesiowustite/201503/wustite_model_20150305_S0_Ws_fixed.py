...
def fO2_wus_eqm_Fe(data, Wij, Wji, H_0_FeO, S_0_FeO, H_0_Fe34O, S_0_Fe34O): # last fO2 should be zero
    ...
    # Interaction parameters
    enthalpy_interaction=[[[0., 0.],[0.,0.]],[[Wij, Wji]]]
    volume_interaction=[[[0., 0.],[0.,0.]],[[0., 0.]]]
    entropy_interaction=[[[0., 0.],[0.,0.]],[[0., 0.]]]
...
for T in Ts:
    ...
    sigma_factor=10.
    sigma_fO2.append(sigma_factor*306./(constants.gas_constant*T*np.log(10.)))
'''
...
T=298.15
mt.params['H_0']=mt.params['H_0']+200.
mt.set_state(Pr, T)
print mt.gibbs, mt.S, mt.H, mt.gibbs + T*mt.S

# Variables should be
# Wh, Ws, H_0_FeO, S_0_FeO, H_0_Fe23O, S_0_Fe23O,  (and Cp_0_FeO?)
guesses=[14.e3, 14.e3, -429440., 60., -450000., 60.]
popt, pcov = optimize.curve_fit(fO2_wus_eqm_Fe, phase_T_ys, logfO2, guesses, sigma_fO2)
Wij, Wji, H_0_FeO, S_0_FeO, H_0_Fe34O, S_0_Fe34O = popt
...
tools.print_mineral_class(wus.endmembers[1][0], 'wustite')
tools.print_mineral_class(wus.endmembers[2][0], 'defect_wustite')
