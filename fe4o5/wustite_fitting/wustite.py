...
class wuestite_ss(burnman.SolidSolution):
    def __init__(self, molar_fractions=None):
        ...
        self.type='symmetric'
        self.endmembers = [[wustite(), '[Fe]O'],[defect_wustite(), '[Fef1/2Vc1/2]Fef1/6O']]

        # Interaction parameters
        self.enthalpy_interaction=[[3.0e3]]
...
temperature = np.linspace(300., 1700., 101)
...
wus.set_composition([1.0-c,c])
print 4*wus.gibbs, mu_mt, mt.gibbs
