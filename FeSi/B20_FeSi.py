...
class B20_FeSi (Mineral):
    def __init__(self):
        ...
        Z = 4.
        V_0 = 90.25*1.e-30*burnman.constants.Avogadro/Z
        #a = 0.448663
...
if __name__ == "__main__":
    ...
    P, T, a, aerr = B20_V_data_RT
    PT = [P*1.e9, T]
    Z = 4.
    V = a*a*a*1.e-30*burnman.constants.Avogadro/Z
    V_sigma = 3.*aerr*1.e-30*burnman.constants.Avogadro/Z
    
    popt, pcov = burnman.tools.fit_PVT_data(FeSi, ['K_0', 'Kprime_0'], PT, V, V_sigma)
    print popt
