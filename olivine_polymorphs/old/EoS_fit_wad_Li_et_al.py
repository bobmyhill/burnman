...
with open('Li_et_al_wad_volumes.dat') as file:
...
P=data.T[0]
T=data.T[1]
volumes=data.T[2]*(nA/Z/voltoa)

# Uncertainties on volume data
sigma=data.T[2]*(nA/Z/voltoa)*0.001
pt=array([P,T]) # P in GPa


# Initial guess.
k1=4.2
mbrV=4.05215556169*10
mbra=2.34898381715e-05
guesses=array([110.])
