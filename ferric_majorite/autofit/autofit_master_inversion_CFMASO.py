...
solution_args = [['mw', 'E', 0, 0, fper.energy_interaction[0][0], 1.e3],
                 ...
                 ['gt', 'E', 0, 2,  gt.energy_interaction[0][2], 1.e3], # py-andr (py-alm is ideal)
...
solution_priors = [['opx', 'E', 0, 0, 0.e3, 1.e3],
                   ...
                   ['gt', 'E', 2, 0,  2.e3, 1.e3]] #, ['bdg', 'E', 0, 0, 4.e3, 0.0001e3]] # ['gt', 'E', 0, 0, 0.3e3, 0.4e3]
...
### PUT PARAMS HERE ###
#######################
set_params([-268.3830, -2178.7694, -1477.0649, -2151.0665, -2140.6418, -1472.3967, -5252.9561, -6634.8927, -5777.2556, -906.8910, -867.9937, -2838.4932, -3094.7676, -2390.1656, -3087.3824, -2392.5097, -1453.2719, -1112.7772, 27.2066, 54.5122, 94.1479, 151.3601, 85.2317, 81.8463, 136.1298, 338.7948, 254.6186, 316.7817, 132.4284, 188.3568, 131.5704, 177.7916, 39.7184, 30.5521, 58.0710, 79.4706, 4.3103, 1.5960, 1.6455, 2.0298, 3.0708, 3.2796, 2.8298, 2.7509, 2.1188, 1.7537, 2.2231, 2.0891, 1.8335, 2.1874, 11.8498, 6.3121, 18.0080, 8.8378, -1.0609, 1.6045, 84.5382, -0.6003, 57.4015, 3.3058, -4.9513, -4.2297, -2.0131, -0.5135, -3.5466, -0.6392, 1.5238, -5.3584, -3.4200, -0.3921, -1.0788, 0.1575, -0.0404, 1.3934, 0.7646, 1.6261, -1.0939, -1.1314, -1.2640, -0.6218, -0.1036, 0.3195, 0.0084, -0.2426, 0.8984, -0.1073, -0.4033, -0.3201, -0.2245, -0.0262, -1.3356, -1.0644, -0.6263, -0.2746])
