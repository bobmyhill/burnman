...
endmember_args = [['nagt', 'H_0', nagt.params['H_0'], 1.e3],
                  ['nagt', 'S_0', nagt.params['S_0'], 1.]]


endmember_priors = []

solution_args = [['gt', 'E', 0, 2,  gt.energy_interaction[0][2], 1.e3], # py-andr
                 ...
                 ['gt', 'V', 1, 1,  gt.volume_interaction[1][1], 1.e-7]] # alm-andr


solution_priors = [] 


experiment_uncertainties = [['Beyer2019_H4321', 'P', 0., 0.2e9],
...
assemblages = [assemblage for assemblage_list in
               [endmember_reaction_assemblages,
                ...
                ONeill_1987_QFM_assemblages, # Frost_2003_FMASO_gt_assemblages,
...
### PUT PARAMS HERE ###
#######################
set_params([-6037.4877, 267.4673, 89.7552, -3.8040, 59.8527, 2.9147, 25.6058, 56.1490, 61.2679, 77.1786, -7.2863, -14.1928, -4.8515, -5.6843, 24.7617, -2.4651, 0.0016, -6.3834, 0.4544, -4.3785, -0.1559, -14.4295, -39.0730, -19.4301, -15.6039])
