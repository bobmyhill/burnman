...
solution_args = [['gt', 'E', 0, 4,  gt.energy_interaction[0][4], 1.e3], # py-nagt
...
set_params([-5990.4622, 269.9557, 0.6857, 0.6280, 0.1321, -1.8217, 0.5104, 0.0407, -0.0442, 1.4885, -0.0883, -0.0068, -0.1211, 0.0480, -1.3893, 0.0716, -0.5456, -6.5469, -3.3017, -1.5326])
