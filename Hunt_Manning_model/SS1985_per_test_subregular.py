...
class hydrous_melt(burnman.SolidSolution):
    def __init__(self):
        ...
        self.enthalpy_interaction=[[[0., 0.],[0.e3,0e3]],[[5.e3, 0.]]]
...
for X in np.linspace(0.001, 0.999, 11):
    print minimize(eqm_order, 0.001, method='TNC', bounds=((0.0, 1.-np.abs(1.-2.*X)),), args=(X, r, P, T), options={'disp': False}).x[0]
...
plt.plot( compositions, Gex_2, '-', linewidth=2., label='model')
