...
H2Omolfraction=np.linspace(0.0001, 0.65, 7)
...
for i, Xs in enumerate(H2Omolfraction):
    ...
    temperatures[i] = fsolve(find_temperature, 2000., args=(P, Xs, r, K, stv, SiO2_liq_alt))
    temperaturesinf[i]=fsolve(find_temperature, 2000., args=(P, Xs, r, Kinf, stv, SiO2_liq_alt))
    temperatures0[i]=fsolve(find_temperature, 2000., args=(P, Xs, r, K0, stv, SiO2_liq_alt))
