...
S_tweak = 4.
dS = 169.595 - 144.532 + S_tweak # JANAF
...
stv.property_modifiers = [['linear', {'delta_E': -5.2e3, 'delta_S': 0., 'delta_V': 0.}]]

SiO2_liq.property_modifiers = [['linear', {'delta_E': (coe.gibbs - SiO2_liq.gibbs) + Tm*(coe.S - SiO2_liq.S + dS) - Pm*dV,
                                           'delta_S': (coe.S - SiO2_liq.S + dS), 'delta_V': dV}]]
