...
wadfeESV = np.array([1.11505465e04, -2.80395144e00, 8.96713987e-08])
ringfeESV = np.array([3.18360572e03, -5.71706066e-01, 3.09190317e-07])
lmfeESV = np.array([2.38453875e03, -5.59492003e00, 4.17619638e-08])
...
lm = {
    ...
    "S": -0.645,
    "V": -3.53e-6,
    "hyE": 100000.0,  # NEED TO CHANGE
    "hyS": -12,  # NEED TO CHANGE
    "hyV": 0.0,  # NEED TO CHANGE
    "feE": lmfeESV[0],
    "feS": lmfeESV[1],
    "feV": lmfeESV[2],
}
...
olwad = {
    ...
    "dhalfPintdT": -4.05e5,
}  # estimated from SLB2011 Figure

wadring = {
    "Delta_E": wad["E"] - ring["E"],
...
Mg2SiO4_params = {
    ...
    "Cp_Pref": np.array([1.49312734e02, 9.66981406e-03, -1.06823762e07, 7.20496606e02]),
...
Fe2SiO4_params = {
    ...
    "Cp_Pref": np.array([1.51964362e02, 8.80493315e-03, -7.74825617e06, 6.51972863e02]),
...
MgSiO3_params = {
    ...
    "Cp_Pref": np.array([1.17851662e02, 3.67545477e-03, -5.58729690e06, 1.86118367e02]),
...
H2O_params = {
    "name": "H2O (based on Pitzer and Sterner (1994) water)",
    "equation_of_state": "mod_hp_tmt",
    "T_0": 298.15,
    "Pref": 17500000000.0,
    ...
    "Cp_Pref": np.array([7.31268765e01, 1.14832240e-03, 1.91210537e07, -1.02859341e03]),
