...
make_new = False
if make_new:
    fo = burnman.CombinedMineral(
        [SLB_2011.forsterite(), SLB_2011.fayalite()], [0.9, 0.1], name="olivine"
    )

    ring = burnman.CombinedMineral(
        [SLB_2011.mg_ringwoodite(), SLB_2011.fe_ringwoodite()],
        [0.9, 0.1],
        name="ringwoodite",
    )
    ...
    lm = burnman.Composite(
        [
            SLB_2011.mg_perovskite(),
            SLB_2011.fe_perovskite(),
            SLB_2011.periclase(),
            SLB_2011.wuestite(),
        ],
        [0.47, 0.03, 0.43, 0.07],
    ...
    Mg2SiO4L.property_modifiers = [
        [
            "linear",
            {"delta_E": mg_wad.gibbs - Mg2SiO4L.gibbs, "delta_S": dS, "delta_V": dV},
        ]
    ]
