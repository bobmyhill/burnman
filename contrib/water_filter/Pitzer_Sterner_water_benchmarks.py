...
print(H2O.method.pressure(Tc, 1.e-6/0.01787, H2O.params))

PS1994_Fig1 = mpimg.imread('data/Pitzer_Sterner_1994_Fig_1.png')
PS1994_Fig2a = mpimg.imread('data/Pitzer_Sterner_1994_Fig2a.png')
plt.imshow(PS1994_Fig1, extent=[0.0, 7., 0., 25.], aspect='auto')
plt.imshow(PS1994_Fig2a, extent=[0.0, 4., 0., 5.], aspect='auto')
...
for T in [Tc, 1600.]:
    for i, volume in enumerate(volumes):
        ...
        reduced_pressures[i] = H2O.method.pressure(T, volume, H2O.params)*volume/(8.31446*T)
...
ax[2].plot(Ts, Gs/1.e3 + 233.2550*298.15/1.e3, linestyle=':', label='Barin gibbs (1 bar; HSC->SUP converted)')
