...
def fitting_function(m_name, formula, fn_type, V_args=None, G_args=None):
    ...
    def fit_V(PT_data, V_0, K_0, Kp_0, Kdp_0, a_0, TE_0):
        ...
        G_params = [-1442310.0, 62.6, 1.61546581e+02, -3.31714290e-03, -3.57533814e+06, -1.11254791e+03]
...
pressures0 = np.linspace(5.e9, 30.e9, 101)
temperatures0 = 1600. + 0.*pressures0

temperatures1 = np.linspace(1000., 2200., 101)
pressures1 = P_ref + 0.*temperatures1
...
V00 = 1.5e-5
K00 = 100.e9 # 24.e9 better starting guess for H2O
Kp00 = 4.
Kdp00 = -Kp00/K00
a00 = 1.e-5
Tein00 = 200.
