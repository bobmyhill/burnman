...
ax[i["T_c"]].scatter(
    Raz["T_C"][idx] + 273.15,
    (1.0 + 0.01 * Raz["dz_z0_pct"][idx]) * Antao["c"][0],
    c=c_Raz,
    label=l_Raz,
)
...
ax[i["T_a"]].scatter(
    Carpenter_XRD["T_K"], Carpenter_XRD["a"], c=c_Carpenter_XRD, label=l_Carpenter_XRD
)
ax[i["T_c"]].scatter(
    Carpenter_XRD["T_K"], Carpenter_XRD["c"], c=c_Carpenter_XRD, label=l_Carpenter_XRD
)
...
for axis in ["a", "c"]:
    ax[i[f"T_{axis}"]].errorbar(
        Antao["T_K"],
        Antao[axis],
        yerr=Antao[f"unc_{axis}"],
        linestyle="None",
        c=c_Antao,
    )
    ax[i[f"T_{axis}"]].scatter(Antao["T_K"], Antao[axis], c=c_Antao, label=l_Antao)

    ax[i[f"V_{axis}"]].errorbar(
        Jorgensen["V"],
        Jorgensen[axis],
        yerr=Jorgensen[f"unc_{axis}"],
        linestyle="None",
        c=c_Jorgensen,
    )
    ax[i[f"V_{axis}"]].scatter(
        Jorgensen["V"], Jorgensen[axis], c=c_Jorgensen, label=l_Jorgensen
    )
    ...
    ax[i[f"V_{axis}"]].errorbar(
        ...
        Scheidl[axis],
        xerr=Scheidl["unc_V"],
        yerr=Scheidl[f"unc_{axis}"],
        linestyle="None",
        c=c_Scheidl,
    )
    ax[i[f"V_{axis}"]].scatter(
        Scheidl["V"], Scheidl[axis], c=c_Scheidl, label=l_Scheidl
    )

    ax[i[f"V_{axis}"]].errorbar(
        Hazen["V"], Hazen[axis], yerr=Hazen[f"unc_{axis}"], linestyle="None", c=c_Hazen
    )
    ax[i[f"V_{axis}"]].scatter(Hazen["V"], Hazen[axis], c=c_Hazen, label=l_Hazen)
