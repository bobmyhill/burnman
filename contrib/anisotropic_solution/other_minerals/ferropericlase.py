...
m = AnisotropicMineral(
    per, cell_parameters, per_anisotropic_parameters(), psi_func, orthotropic=True
)
...
fig.savefig("figures/periclase_stiffness_tensor.pdf")
fig2.set_tight_layout(True)
fig2.savefig("figures/periclase_shear_modulus.pdf")
plt.show()
...
ln = ax[0].plot(temperatures, G_R / 1.0e9, color=ln[0].get_color(), label="$G$")
...
fig.set_tight_layout(True)
fig.savefig("figures/periclase_properties_1bar.pdf")
plt.show()
