...
ax[0].plot(path_temperatures, path_pressures/1.e9, linestyle='--', color='blue', linewidth=3)
ax[0].plot(path_temperatures_2, path_pressures_2/1.e9, linestyle='--', color='blue', linewidth=3)

ax[1].plot(path_entropies, path_pressures/1.e9, linestyle='--', color='blue', linewidth=3)
ax[1].plot(path_entropies_2, path_pressures_2/1.e9, linestyle='--', color='blue', linewidth=3)

ax[2].plot(path_pressures*0., path_pressures/1.e9, linestyle='--', color='blue', linewidth=3)
ax[2].plot(path_liq_fractions_2, path_pressures_2/1.e9, linestyle='--', color='blue', linewidth=3)

ax[0].plot(temperatures, pressures/1.e9)
ax[1].plot(S_sol, pressures/1.e9)
ax[1].plot(S_liq, pressures/1.e9)
...
fig.savefig('figures/di_melting_path.pdf')
plt.show()
