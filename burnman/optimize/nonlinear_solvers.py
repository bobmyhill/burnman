...
def damped_newton_solve(
    ...
    :returns: A namedtuple with the following attributes:
        * x - The solution vector. 1D numpy array of floats.
        * F - The evaluated function F(x). 1D numpy array of floats.
        * F_norm - Euclidean norm of F(x). float.
        * J - The evaluated Jacobian J(x). 2D numpy array of floats.
        * n_it - Number of iterations. integer.
        * code - Numerical description of the solver termination. integer.
        ...
        * text - Description of the solver termination. string.
        * success - Solution convergence boolean.
        * iterates : namedtuple
