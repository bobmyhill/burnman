...
class AAMOD(eos.EquationOfState):
    """
    ...
    def _C_v_el(self, V, T, params):
        return electronic.heat_capacity_v(T, params['V_0']/V,
    ...
    def _internal_energy_el(self, Ts, T, V, params):
        return electronic.thermal_energy(T, params['V_0']/V,
                                         params['T_el'], params['Cv_el']) \
            - electronic.thermal_energy(Ts, params['V_0']/V,
                                        params['T_el'], params['Cv_el'])
    ...
    def _entropy_el(self, Ts, T, V, params):
        return electronic.entropy(T, params['V_0']/V,
                                  params['T_el'], params['Cv_el']) \
            - electronic.entropy(Ts, params['V_0']/V,
                                  params['T_el'], params['Cv_el'])
