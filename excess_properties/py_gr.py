...
guesses = [266., 266., 10.]
popt, pcov =  curve_fit(symmetric, c_obs, deltaH_sol, guesses)
...
print 'Warning: H and S not redone yet!!'
...
pygr.params['K_0'] += 3.e9 # Tweak to make sure excess volume doesn't go negative
grpy.params['K_0'] += 3.e9 # Tweak to make sure excess volume doesn't go negative
