...
awk '{print $1, $4}' data/pyrope_grossular_bulk_sound_velocities.dat | psxy -J -R -O -K -W1,grey,- >> ${base}.ps

awk '{print $1, $2}' data/pyrope_grossular_bulk_sound_velocities.dat | psxy -J -R -O -K -W1,black >> ${base}.ps
awk '$1<8 {print $1, $2}' data/pyrope_grossular_bulk_sound_velocities_disordered.dat | psxy -J -R -O -K -W1,black,- >> ${base}.ps




printf "1 8.8 \n 2.5 8.8" | psxy -J -R -O -K -W1,black >> ${base}.ps
echo "3 8.8 Fit, ordered" | pstext -J -R -O -K -F+jLM >> ${base}.ps

printf "1 8.6 \n 2.5 8.6" | psxy -J -R -O -K -W1,black,- >> ${base}.ps
echo "3 8.6 Fit, disordered" | pstext -J -R -O -K -F+jLM >> ${base}.ps

printf "1 8.4 \n 2.5 8.4" | psxy -J -R -O -K -W1,grey,- >> ${base}.ps
echo "3 8.4 Constant excess volume" | pstext -J -R -O -K -F+jLM >> ${base}.ps

printf "1 8.2 \n 2.5 8.2" | psxy -J -R -O -K -W1,grey >> ${base}.ps
echo "3 8.2 Ganguly et al. (1996)" | pstext -J -R -O -K -F+jLM >> ${base}.ps
