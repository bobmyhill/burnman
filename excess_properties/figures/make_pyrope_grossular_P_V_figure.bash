...
psxy -J -R -O -K data/pyrope_grossular_P_V.dat -W0.5,black >> ${base}.ps
psxy -J -R -O -K data/pyrope_grossular_P_V_disordered.dat -W0.5,black,- >> ${base}.ps
...
echo "9.3 111 Py@-80@-" | pstext -J -R -O -K -F+jLM >> ${base}.ps
echo "9.3 113.4 Py@-60@-" | pstext -J -R -O -K -F+jLM >> ${base}.ps
echo "9.3 115.8 Py@-40@-" | pstext -J -R -O -K -F+jLM >> ${base}.ps
echo "9.3 118 Py@-20@-" | pstext -J -R -O -K -F+jLM >> ${base}.ps
