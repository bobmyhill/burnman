...
if __name__ == "__main__":
    ...
    of low spin wuestite. We do make it slightly smaller and stiffer than
    MgO, to agree with the experimental data reported by Solomatova et al. (2016).
    """
    ...
    formula = {'Fe': 1., 'O': 1.}
    low_spin_wuestite_params = {'name': 'low spin Wuestite',
                                'formula': formula,
    ...
    low_spin_wuestite = burnman.Mineral(params=low_spin_wuestite_params)
